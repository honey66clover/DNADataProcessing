...
im1=ax1.imshow(Z, interpolation='bicubic', origin='lower',cmap=None,vmin=0,vmax=0.35,extent=(80,150,0,150))
#im1.set_clim=(0,0.35)
...
#im=imshow(Z, interpolation='bicubic', origin='lower',cmap=None,norm = colors.Normalize(vmin=0, vmax =1, clip=False), extent=(80,150,0,150))
im2=ax2.imshow(Z, interpolation='bicubic', origin='lower',cmap=None,vmin=0,vmax=0.35,extent=(80,150,0,150))
#im2.set_clim=(0,0.35)
ax2.set_ylim(15,100)
...
savefig('C:\Users\honey66clover\Desktop\Weijuan\DNA\HU\sample pictures2\s2\s2.2.png', dpi=600) 