...
#the probability that the DNA is bound by 2HU or 3HU
filename="C:\Users\honey66clover\Desktop\Weijuan\DNA\HU\sample pictures2\s2\j factor and binding probabilities 1per50.csv"
df=pd.read_table(filename,sep=',')
prob2=df['2HU(1HU/50)'] #prob2[2] is for chain length 82
prob3=df['3HU(1HU/50)']
print prob2[2]
...
for i in range(0,70):
    z[i,]=z[i,]*prob2[i]
Z=z[X,Y] #z[3,41] is for chain length 83 at position 41
Z=np.nan_to_num(Z)
...
im1=ax1.imshow(Z, interpolation='bicubic', origin='lower',cmap=None,vmin=0,vmax=0.25,extent=(80,150,0,150))
#im1.set_clim=(0,0.35)
...
#im=imshow(Z, interpolation='bicubic', origin='lower',cmap=None,norm = colors.Normalize(vmin=0, vmax =1, clip=False), extent=(80,150,0,150))
im2=ax2.imshow(Z, interpolation='bicubic', origin='lower',cmap=None,vmin=0,vmax=0.25,extent=(80,150,0,150))
#im2.set_clim=(0,0.35)
ax2.set_ylim(15,100)
...
colorbar(im2, ticks=[0,0.05,0.1,0.15,0.2,0.25,0.3,0.35],cax=ax3)
...
#ax3.set_yticks([0.1,0.2,0.3])    
#ax3.set_yticklabels([0,'',0.1,'',0.2,'',0.3])
ax3.text(0, -0.07,r'$\mathit{w}$',fontsize=8)
setp(ax2.get_yticklabels(),visible=False)

savefig('C:\Users\honey66clover\Desktop\Weijuan\DNA\HU\sample pictures2\s2\s2.4.png', dpi=600) 