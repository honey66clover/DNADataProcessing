...
ax1.legend([p1,p2],["circle","all"],bbox_to_anchor=(0.312, 0.615,0.5, -0.2),loc=8,fontsize=8,borderpad=0.2,ncol=2,handletextpad=0.,columnspacing=0.5)#not controlled by rc.font
...
ax2.set_ylabel('percentage of configurations',fontsize=8)
ax2.legend((p2[0],p3[0]),('2HU',r'$\mathregular{\geqslant}$'+'3HU','4HU'),bbox_to_anchor=(0.4, 0.76,0.5, -0.2),loc=8,fontsize=8)
