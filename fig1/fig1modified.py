...
gs2.update(left=0.46, right=1., hspace=0.05)
...
ax1.text(100, 3.6,'A',fontsize=7)
ax1.text(157, 3.6,'B',fontsize=7)
...
p2=ax2.bar(x,HU2,color='0',linewidth=0)
p3=ax2.bar(x,HU3,color='0.4',bottom=HU2,linewidth=0)
p4=ax2.bar(x,HU4,color='0.8',bottom=HU3+HU2,linewidth=0)

ax2.set_xlabel('DNA chain length (bp)',fontsize=7)
ax2.set_xticks([105, 126, 147])
ax2.set_ylabel('# configurations'+r'$\times 10^4$',fontsize=7)
...
bx1.set_yticks([0.008,0.016])
bx1.set_ylabel(r'$w$'+'(HU)',fontsize=7)
...
bx4.set_ylabel('Sampled configuration',fontsize=7)
...
#show()
savefig('C:\Users\honey66clover\Desktop\Weijuan\DNA\HU\sample pictures2\\fig1\\fig1',dpi=600)