...
rloopfile='/home/juanwei/snapshots_nProtein/1HUper200/%(bp)i/loops-minicircle_%(bp)i_HU+187.dat' % locals() #read loop*.dat files to look for nProteins and the two Seeds
wfilename="/home/juanwei/PCAfiles/1HUper200/all/PCA_%(bp)i_1HUper200_all.dat" % locals()
wfilename2="/home/juanwei/PCAfiles/1HUper200/2HU/PCA_%(bp)i_1HUper200_2HU.dat" % locals()
wfilename3="/home/juanwei/PCAfiles/1HUper200/3HU/PCA_%(bp)i_1HUper200_3HU.dat" % locals()
with open (rloopfile, 'rb') as rfile, open(wfilename,'wb') as wfile, open(wfilename2,'wb') as wfile2, open(wfilename3,'wb') as wfile3:
	...
	for row in reader:
		...
		Seed2=row[5]
		nProtein=int(row[7])
		for file in os.listdir('/home/juanwei/snapshots_nProtein/1HUper200/%(bp)i/'% locals()): #location of the read dat files
			if fnmatch.fnmatch(file, 'steps_%(bp)i*%(Seed1)s,%(Seed2)s.dat' % locals()): 
				call(["/home/juanwei/localsoftware/x3dna-v2.1/bin/x3dna_utils","cp_std","BDNA"])
				call(["/home/juanwei/localsoftware/x3dna-v2.1/bin/rebuild","-atomic","/home/juanwei/snapshots_nProtein/1HUper200/%(bp)i/%(file)s" % locals(),"/home/juanwei/pdbfiles/%(bp)i_1per200.pdb"  % locals()]) #location of the output pbd files
				if os.path.isfile("/home/juanwei/PCAfiles/1HUper200/%(bp)i/ref_frames.dat"% locals()):
					rfilename="/home/juanwei/PCAfiles/1HUper200/%(bp)i/ref_frames.dat" % locals()
