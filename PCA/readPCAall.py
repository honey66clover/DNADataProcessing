...
with open ("PCA1all.dat", 'wb') as wfile1,open ("PCA2all.dat", 'wb') as wfile2,open ("PCA3all.dat", 'wb') as wfile3:
	for bp in range(100,150):
		pca=np.genfromtxt("PCA_%(bp)i_HUper100.dat" % locals(),delimiter=',')# matrix with 3 cols for each PCA component
