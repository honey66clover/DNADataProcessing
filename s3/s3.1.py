...
ax1.legend([p1,p2],["circle","all"],bbox_to_anchor=(1.06, 0.63),fontsize=8,borderpad=0.15,handletextpad=0.,labelspacing=0.1,columnspacing=0.2)
...
bx1.set_ylabel('percentage of configurations',fontsize=8)
...
savefig('C:\Users\honey66clover\Desktop\Weijuan\DNA\HU\sample pictures2\s3\s3.1.png',dpi=600)