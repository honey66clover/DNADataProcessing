...
gs1 = gridspec.GridSpec(1, 4,width_ratios=[38,36,28,38])
...
gs2 = gridspec.GridSpec(1, 4,width_ratios=[27,32,31,41])
...
ax[2].set_xlim((460,740))#280
ax[3].set_xlim((420,800))#380
bx[0].set_xlim((440,710))#270
bx[1].set_xlim((540,860))#320
...
fig.savefig('C:\Users\honey66clover\Desktop\Weijuan\DNA\HU\sample pictures2\\fig5\\fig5.2\\fig5.2.png', dpi=600)
